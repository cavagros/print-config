...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold mb-8">Modifier le type de juridiction</h1>

    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('admin.settings.jurisdiction.update', $jurisdiction->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                <label class="flex items-center">
                    <input type="checkbox" name="is_active" value="1" 
                        {{ old('is_active', $jurisdiction->is_active) ? 'checked' : '' }}
                        class="mr-2">
